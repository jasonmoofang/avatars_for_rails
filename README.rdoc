...
* Form-level identifying of model to update avatar of in avatar form
* Updates so the gem works properrly with latest versions of rails (v4) and related gems (like jquery-ui v5 onwards)
...
* In order to get a nice progress slider in the avatar form, you should have bootstrap css included in
your project, though this is not mandatory for the gem to work.
